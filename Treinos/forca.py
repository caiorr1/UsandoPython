...
def jogar():
    ...
    letras_acertadas = formata_letras_acertadas(palavra_secreta)
    ...
    if(acertou):
        ...
        imprime_mensagem_perca(palavra_secreta)
...
def formata_letras_acertadas(palavra):
...
def imprime_mensagem_perca(palavra_secreta):
